...
var Week = function (_React$Component) {
    ...
    _createClass(Week, [{
        ...
        value: function buildWeeklyDayCols() {
            var timeDivs = [];
            for (var i = 1; i <= 7; i++) {
                timeDivs.push(_react2.default.createElement("td", { key: i, className: "rc-weekly-day-col" }));
            }
            return timeDivs;
        }
    }, {
