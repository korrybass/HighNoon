...
var CalendarContainer = function (_React$Component) {
    ...
    function CalendarContainer() {
        ...
        _this.state = {
            ...
            displayDates: _this.generateMonthlyDate((0, _moment2.default)()),
            displayView: 'month'
        };
        return _this;
    }
    ...
    _createClass(CalendarContainer, [{
        ...
        value: function generateMonthlyDate(date) {
            ...
            return monthData.map(function (x, idx) {
                return _react2.default.createElement(
                    'div',
                    { className: 'rc-day', key: idx },
                    _react2.default.createElement(_day2.default, { dayNumber: x })
                );
            });
        }
    }, {
        ...
        value: function goToPrevMonth() {
            this.setState({
                ...
                displayDates: this.generateMonthlyDate(_CalendarMonthLogic2.default.getPreviousMonth(this.state.currentMonth))
            });
        }
    }, {
        key: 'goToNextMonth',
        value: function goToNextMonth() {
            this.setState({
                ...
                displayDates: this.generateMonthlyDate(_CalendarMonthLogic2.default.getNextMonth(this.state.currentMonth))
            });
        }
    }, {
        key: 'render',
...
},{"../../../logic/CalendarMonthLogic":5,"./Day/day":3,"./nextBtn":4,"moment":6,"react":"react"}],3:[function(require,module,exports){
"use strict";
...
},{"../../../logic/CalendarMonthLogic":5,"react":"react"}],5:[function(require,module,exports){
'use strict';
...
var buildMonthArray = function buildMonthArray(monthRange) {
    var range = [];
...
var setMonthDatesView = function setMonthDatesView(date) {
    ...
    return [].concat(_toConsumableArray(prevMonthDates.reverse()), _toConsumableArray(buildMonthArray(numberOfDaysInMonth(date))), _toConsumableArray(nextMonthDates));
};
