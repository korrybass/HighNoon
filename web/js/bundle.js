...
var CalendarContainer = function (_React$Component) {
    ...
    function CalendarContainer() {
        ...
        _this.state = {
            ...
            displayDates: [],
            displayView: 'month',
            eventSource: [(0, _moment2.default)()]
        };
        return _this;
    }
    ...
    _createClass(CalendarContainer, [{
            ...
            return monthData.dates.map(function (x, idx) {
                ...
                return _react2.default.createElement(
                    ...
                    { onClick: function onClick() {
                            dayAction(x.date);
                        }, className: 'rc-day ' + dayClass, key: idx },
                    _react2.default.createElement(_day2.default, { events: dateEvents, rcDate: x.date, dayNumber: x.day })
                );
            });
        }
    }, {
        ...
        value: function componentDidMount() {
            this.setState({ displayDates: this.generateMonthlyDate((0, _moment2.default)()) });
        }
    }, {
        key: 'render',
...
},{"../../../logic/CalendarMonthLogic":6,"./Day/day":3,"./nextBtn":5,"moment":7,"react":"react"}],3:[function(require,module,exports){
'use strict';
        ...
        value: function createEvents() {
            return this.props.events.map(function (x, idx) {
                ...
                return _react2.default.createElement(
                    'div',
                    { key: idx },
                    _react2.default.createElement(_rcEvent2.default, { date: x.format("ha"), title: 'test' })
                );
            });
        }
    }, {
...
},{"../Event/rc-event":4,"react":"react"}],4:[function(require,module,exports){
"use strict";
...
},{"../../../logic/CalendarMonthLogic":6,"react":"react"}],6:[function(require,module,exports){
'use strict';
